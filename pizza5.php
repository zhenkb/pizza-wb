...
<body>
    ...
    <div class="w3-card-4" style="display: flex; justify-content: center; width: 50%; margin: 0 auto;">
        <!-- Image Section -->
        <img src="pizza/Pizza-5.jpg" alt="Alps" style="width: 50%;">

        <!-- Text Section -->
        <div style="flex: 1; padding-left: 20px;">
        <h3 style="text-align: left;">
                起司披薩是一款簡單而經典的披薩，主角是濃郁的起司。
                這款披薩的餅皮酥脆，搭配了滿滿的莫札瑞拉起司，每一口都能享受到絲滑的口感。
                起司披薩的美味來自於它的純粹，無需過多的配料，讓起司的香濃味道成為焦點。
                是許多人最愛的選擇，特別適合喜歡奶香味的朋友，無論是單獨食用還是搭配其他菜肴，都是不敗的美味。
            </h3>
        </div>
    </div>
</div>
